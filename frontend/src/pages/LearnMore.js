...
function LearnMore() {
	...
	return (
		<div className='m-0 mt-14 mb-60 flex justify-center p-1'>
			<div className='font-inter flex w-[80vw] flex-col place-content-center place-items-center gap-5 text-zinc-300'>
				...
				<p className='indent-4 text-base font-light'>
					In order to get where we would like to have this project it will take
					some time and some community support.{" "}
				</p>
				<button
				...
				<p className='indent-4 text-base font-light'>
					The Trickedex is the final goal for the current tricking-3d project in
					the works. The Trickedex is loosely based off the concept of the
				...
				<p className='indent-4 text-base font-light'>
					...
					to overcome the obstacles in our ways. That understanding is something
					that extends well beyond flips. So if we can get more people Tricking,
					and maybe coming to that understanding, those people will go on to do
					great things for all of us. The rising tide lifts all ships. So let us
					be that tide.
				</p>
				<DonateText />
			</div>
