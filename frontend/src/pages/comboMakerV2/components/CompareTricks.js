...
const CompareTricks = ({ newCombo }) => {
	...
	return (
		<div className='no-scrollbar relative mb-10 h-[60vw] min-h-[80px] w-[85vw] overflow-y-scroll rounded-md bg-teal-400 p-2 text-zinc-900 shadow-lg shadow-teal-600'>
			<div
