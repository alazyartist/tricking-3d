	...
	return (
		<div className='font-inter mt-4 flex flex-col place-content-center place-items-center font-bold text-zinc-300'>
			...
			<div className='w-[60vw] pt-4'>
				...
				into the starting position for a particular trick. We have generally
				been referring to pure setups as opposed to setup tricks or setup
				combos. However colloquially you will hear the term setup used to refer
				to all three. Pure setups are the initial movements used to generate
				momentum and get into the starting position for the first Trick
				performed. <br />
				<br />
				...
				the upcoming Trick. The pure setups generally include J-Step, K-Step,
				Euro-Step, Pivot, back-step, Spin Step, Skip Step, as well as Standing.
				Each of these is used to position the body in a different way depending
				on which Trick you want to perform. Many of these are just slight
				variations of simmilar ways into the same Tricks. Typically only having
				slight alterations made between them it us up to the Tricker which ones
				feel the best for a particular Trick. <br />
				<br />
				...
				style trick. This doesn't mean that someone couldn't do something like a
				spin-step into a backswing trick. They most certainly could. <br />
				<br /> Any setup can be used to get into any trick you'd like, although
				its arguable that some are better suited for particular Tricks than
				others. That's the joy of Tricking though, you get to make it your own
				through the way you approach things. So whichever setups you'd like to
				...
				the setup we chose. Finding the right setup to use is one that will only
				come through exploration of each of these, as well as creating your own.
