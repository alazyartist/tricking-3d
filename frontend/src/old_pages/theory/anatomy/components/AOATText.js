...
function AOATText() {
	return (
		<div className='w-[60vw] text-zinc-400'>
			We can start with the Anatomy of a Trick. This is a way of breaking down
			the Trick into more manageable chunks that contain useful information
			about the Trick. Having a way to label each of these sections allows for a
			deeper understanding of how Tricks are made up out of other elements. It
			also gives a structured way to play with new ideas by rearranging or
			variating their parts.
			<br />
			<br />
			...
			***Insert Graphic Anatomy of a Combo*** When tricks are performed in a
			...
			within this structure. We mentioned briefly the Stances, Setups and
			Transitions. We will also need to incorporate the flips, kicks, and
			rotations previously mentioned, and introduce grabs, touchdowns, and
			shapes. Once we have done this we will have the majority of movements we
			will need in order to create just about any Trick we can think of!
		</div>
	);
}

export default AOATText;
