...
const CompareTricks = ({ newCombo }) => {
	...
	return (
		<div className='no-scrollbar relative mb-10 h-[60vw] min-h-[80px] w-[85vw] overflow-y-scroll rounded-md bg-zinc-300 bg-opacity-[13%] p-2 text-zinc-900 backdrop-blur-xl'>
			<div
