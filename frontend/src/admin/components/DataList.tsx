        ...
        {tricks
          ...
          ?.map((trick) => (
            <div
              ...
              className=" grid  w-full grid-cols-6 place-items-center justify-between p-2 odd:bg-zinc-700 odd:bg-opacity-70 even:bg-zinc-900 even:bg-opacity-70"
            >
      ...
      <div>
        {combos
          ...
          ?.map((combo) => (
            <div
              key={Math.random()}
              className="grid w-[70vw] grid-cols-4 place-content-center place-items-center justify-between p-2 text-sm odd:bg-zinc-700 odd:bg-opacity-70 even:bg-zinc-900 even:bg-opacity-70"
            >
